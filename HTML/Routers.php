		      ...
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <!-- <li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					...
					<liclass="active"><a href="../HTML/Routers.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>">راوتر</a></li>
...
<section class="footer">
	...
	<div class="copyright text-center">
                   Copyright&copy;2019 <span>Bird Shop</span>.Nagham
            </div>
        </section>

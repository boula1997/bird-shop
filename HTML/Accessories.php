    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <!-- logo  -->
            <a class="navbar-brand" href="#"><span>Bird</span> Shop</a>
          </div>
		      ...
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <!-- <li class="dropdown">
				  ...
				  <ul class="dropdown-menu">
					...
					<li class="active"><a href="../HTML/Accessories.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>">اكسسورات</a></li>
...
$stmt = $pdo->query("SELECT id, Price_disc,name, Price,description FROM items where types='accessory'");

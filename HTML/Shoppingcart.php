        ...
        <div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navtest">
		      <ul class="nav navbar-nav navbar-right">
		        ...
		        <li class="active"><a href="../HTML/Shoppingcart.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>">عربة التسوق </a></li>
...
<section class="price_table text-center">
	...
	<h1>قم بشراء ما تريد<span>بارخص الاسعار</span> & <span>والعروض </span></h1>
		...
		<?php
$id=$_GET['coustmer_id'];
$stmt = $pdo->query("SELECT id, Price_disc,name, Price,description FROM items where id in (select product_id from pruchaces where coustmer_id=$id) ");
				...
				<div class="col-md-4 col-sm-6 col-xm-12">
					<div class="price_box wow fadeInUp" data-wow-duration="2s" data-wow-offset="200">
						...
						<ul class="info list-unstyled">
							...
							<a onclick="prompt('determine quantity');" href="checkout.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>&product_id=<?php echo number_format($row['id']);?>">تاكيد الشراء</a>   
							<br>  
							<a href="delete.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>&product_id=<?php echo number_format($row['id']);?>">ازالة من العربة</a>    

...
<section class="register text-center">
    <div class="container-fluid">
        ...
        <p class="lead">مرحبا بك في موقعنا</p>
...
<div class="col-md-12 wow fadeInUp"data-wow-duration="1s" data-wow-offset="300" >
        ...
        <div class="form-group">
            <input type="text" class="form-control input-lg"  placeholder="الاسم الول" name="First_Name">
        </div>
        <div class="form-group">
            <input type="text" class="form-control input-lg"  placeholder="الاسم الثاني" name="Last_Name">
        </div>
        <div class="form-group">
            <input type="password" class="form-control input-lg" placeholder="كلمة السر" name="My_Password">
        </div>
        <div class="form-group">
            <input type="password" class="form-control input-lg" placeholder="تاكيد كلمة السر" name="Confirm_Password">
        </div>
        

        <button type="submit" value="submit" class="btn-lg btn-block">تسجيل</button>
                <a href="../HTML/Log in.php"> لدي حساب بالفعل</a>

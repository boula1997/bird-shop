...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <!-- logo  -->
      <a class="navbar-brand" href="Home.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>"><span>Bird Shop</span></a>
    </div>

    <div class="collapse navbar-collapse" id="navtest">
		      <ul class="nav navbar-nav navbar-right">
		        <li class="active"><a href="../PHP/Home.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>">الصفحة الرئسية <span class="sr-only">(current)</span></a></li>
...
<section class="contact-us text-center">
	<div class="container">
		...
		<h1>تواصل معنا لشراء للمحلات</h1>
		<p class="lead">اول خطواتك في طريق تجارة الطيور</p>
<div class="col-md-6 wow bounceInLeft"data-wow-duration="1s" data-wow-offset="300" >
 <form action="PHP3.php?coustmer_id=<?php echo number_format($_GET['coustmer_id']);?>" method="POST" role="role ">
		...
		<div class="form-group">
			<input type="text" class="form-control input-lg"  placeholder="الاسم" name="User_Name">
		</div>

		<div class="form-group">
			<input type="text" class="form-control input-lg" placeholder="البريد الالكتروني" name="Email">
		</div>

		<div class="form-group">
			<input type="text" class="form-control input-lg" placeholder="رقم الهاتف" name="Cell_Phone">
		</div>
	 ...
	 <div class="col-md-6 wow bounceInRight"data-wow-duration="1s" data-wow-offset="300">
		<div class="form-group">
			<textarea class="form-control input-lg" placeholder="توضيح للكمية" name="Comment"></textarea>
			
		</div>
		<button type="submit" value="submit" class="btn-lg btn-block">ارسال</button>
 </form>
